        ...
        <ul class="nav nav-pills nav-sidebar flex-column " data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open " >
            <a href="<?php echo e(url('admin/pending')); ?>" class="nav-link active">
              ...
              <p>
                    Room requests <span class="badge badge-dark"><?php echo e($pending); ?></span>
            ...
            <a href="<?php echo e(url('admin/streamers')); ?>" class="nav-link active">
              ...
              <p>
                    Streamers Requests <span class="badge badge-dark"><?php echo e($streamers_requests); ?></span>
              </p>
            </a>
...
<?php /**PATH C:\xampp\htdocs\BBB_Project\BBB_DEMO\resources\views/layouts/admin.blade.php ENDPATH**/ ?>