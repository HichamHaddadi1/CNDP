...
<div class="container "style="width:20%; margin-left:5%; margin-top:1%;">
  <h3 class="display-4">Event Schedule</h3>
  <div class="alert alert-info p-3 ">
  <p class="text-muted h3">All the events are listed here , and you can have access to all of them and be part of <strong>TAMKINE</strong>  community</p>
  </div>
 

</div>
<div class="container-fluid" style="height: 60%; width:60%;margin-top:-30%;" >

  


    <div id="calendar" class="container " style="margin-left: 25%;"></div>
...
<?php echo $__env->make('layouts.viewer_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BBB_Project\BBB_DEMO\resources\views/Viewer/viewer_schedule.blade.php ENDPATH**/ ?>