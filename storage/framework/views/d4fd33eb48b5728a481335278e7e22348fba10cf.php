...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-5">
    <!-- Brand Logo -->
    <a href="<?php echo e(route('viewer_home')); ?>" class="brand-link" target="_blank">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="<?php echo e(url('user/profile')); ?>" class="d-block" style="text-decoration: none"><?php echo e(Auth::user()->name); ?></a>
        </div>
      </div>
      <!-- Sidebar Menu -->
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="<?php echo e(url('user/events')); ?>" class="nav-link active">
            ...
            <a href="<?php echo e(url('/contact')); ?>" class="nav-link active">
...
<?php /**PATH C:\xampp\htdocs\BBB_Project\BBB_DEMO\resources\views/normal_users/user_layout.blade.php ENDPATH**/ ?>