...
e.preventDefault();
$.ajax({
      url: "<?php echo e(route('validator.room_update')); ?>",
      method:"POST",
      processData: false,
      contentType: false,
      dataType: 'json',
...
<?php echo $__env->make('EventValidator.EV_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\plateforme-seminaire\resources\views/EventValidator/rooms.blade.php ENDPATH**/ ?>