...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(route('index')); ?>" class="brand-link" target="_blank">
      <img src="\img\logo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-4" style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <a href="<?php echo e(url('streamer/planning')); ?>" class="nav-link active">
              ...
              <a href="<?php echo e(url('streamer/presentation')); ?>" class="nav-link active">
...
<?php /**PATH C:\Users\Tamkin\Desktop\Nouveau dossier\plateforme-seminaire\resources\views/streamers/streamer.blade.php ENDPATH**/ ?>