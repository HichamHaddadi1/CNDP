...
<div id="body">
 ...
 <div class="div_live" >
   <?php if(!Auth::check()): ?>
<a id="tutorial"><i class="fas fa-chalkboard-teacher"></i>Start Tutorial</a>
   <?php endif; ?>
  ...
  ?>
    <div class="data_events">
      ...
      <div class="blog-card wow fadeInLeft" style="-webkit-animation-delay: 0.1s; -moz-animation-delay: 0.1s; animation-delay: 0.1s;">
        <div class="meta">
        ...
        <div class="description">
          <h1 style="color:white;"><span class="fas fa-broadcast-tower" style="color:#FF6A3D;"></span> <?php echo e($event->event_theme); ?></h1>
          <h2> ON AIR</h2>
          ...
          <p class="read-more">
            <a class="btn btn-primary" href="<?php echo e(route('join' , $event->id_room)); ?>" style="color:#fff;">Join Now</a>
          </p>
        </div>
      </div>
    </div>
    ...
    ?>
      <div class="blog-card">
        ...
        <div class="description">
          ...
          <p class="read-more">
            <a class="btn btn-primary" href="<?php echo e(route('viewer_events')); ?>" style="color:#fff;">View More</a>
          </p>
        </div>
      </div>
     ...
     ?>
      ...
      <?php
       ...
       $j++;
      ?>
      <div class="blog-card combacklater">
       <div class="description">
...
<div class="platform_desc container">
  <h2 style="color: #1A2238;font-weight: bolder;text-align: center">Presentation</h2>
  <p>
...
<div class="swiper_wrraper col-5">
  <!--TAMKINE FOR HOME-->
...
introJs().setOptions({
  ...
  {
    title: 'Facebook Page',
    element: document.querySelector('.fb-page'),
    intro: 'This is our Facebook Page you can Find our News & Updates',
    position:'auto'
  ...
  {
    title:'Information',
    element: document.querySelector('.platform_info'),
  ...
  ,
  {
    ...
    element: document.querySelector('.certified'),
    intro: 'Certification That Our Foundation Offers',
    position:'auto'
  }
,{
...
<?php echo $__env->make('layouts.viewer_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BBB_origin\BBB_DEMO\resources\views/Viewer/viewer_home.blade.php ENDPATH**/ ?>