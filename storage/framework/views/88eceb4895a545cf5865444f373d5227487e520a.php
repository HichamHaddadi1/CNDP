...
<div class="container">
<h2 class="m-3">Streamers Rooms</h2>
 ...
 <div class="row">
  <div class="col-lg-4 col-lg-offset-4">
    ...
    <tbody>
        ...
        <td><?php echo e($room->room_desc); ?></td>
        ...
        <td colspan="3">
          ...
          <button class="btn btn-primary btn-sm" style="color: white" data-clipboard-text="<?php echo e(route('join' , $room->id)); ?>">
            Copy Link
           </button> 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BBB_Project\BBB_DEMO\resources\views/admin_rooms.blade.php ENDPATH**/ ?>