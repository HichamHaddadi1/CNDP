...
<div id="body">
  ...
  ?>
    <div>
        ...
        <?php if($i==0 && $event->event_statue==true && \Carbon\Carbon::now()->diffInHours($event->ending_at)<=4): ?>
      <?php
        $i++;
      ?>
      ...
      <div class="blog-card wow fadeInLeft" style="-webkit-animation-delay: 0.1s; -moz-animation-delay: 0.1s; animation-delay: 0.1s;"">
        <div class="meta">
          <div class="photo" style="background-image: url(/storage/images/<?php echo e($event->id_user); ?>/<?php echo e($event->avatar); ?>)"></div>
          <ul class="details">
        ...
        <div class="description">
          <h1 style="color:white;"><span class="fas fa-broadcast-tower" style="color:#FF6A3D;"></span> <?php echo e($event->room_name); ?></h1>
          <h2> ON NOW</h2>
          ...
          <p class="read-more">
            <a class="btn btn-primary" href="#" style="color:#fff;">Watch</a>
          </p>
        </div>
      </div>
    </div>
      <?php elseif($j==0 && $event->event_statue==false && \Carbon\Carbon::now()->lte($event->starting_at) && $i>=0): ?>
      <?php
        $j++;
      ?>
      <div class="blog-card">
        ...
        <div class="description">
          <h1 style="color:white;" class="f-w-600"><?php echo e($event->room_name); ?></h1>
          <h2>Starting Soon</h2>
