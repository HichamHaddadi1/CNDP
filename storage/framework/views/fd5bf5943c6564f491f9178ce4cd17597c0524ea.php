...
<script>
  ...
  $(document).ready(function () {
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            $('#event-start').val(event.start.toISOString().replace('T' , " "));
            $('#event-end').val(event.end.toISOString().replace('T' , " "));
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\BBB_origin\BBB_DEMO\resources\views/admin_planning.blade.php ENDPATH**/ ?>