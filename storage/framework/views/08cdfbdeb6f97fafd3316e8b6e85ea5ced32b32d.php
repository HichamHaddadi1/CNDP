                                    ...
                                    <div class="custom-file">
                                     ...
                                     -->
                                      <div class="custom-file-upload">
                                        ...
                                        <input type="file" id="file" name="image"  accept="image" multiple />
                                      </div>
                            ...
                            <form action="<?php echo e(route('user_profile_update' , Auth::user()->id)); ?>" method="GET">
                              <div class="card-block">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-sm-6">
                                    <p class="m-b-10 f-w-600">Update Password</p>
                                    <h6 class="text-muted f-w-400"> 
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Seminaire-CNDP\resources\views/admin_profile.blade.php ENDPATH**/ ?>