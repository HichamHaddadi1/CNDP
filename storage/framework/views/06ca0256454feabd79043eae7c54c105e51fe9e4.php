  ...
  <div class="col-lg-4 col-lg-offset-4">
    ...
    <tbody>
       ...
       <?php echo csrf_field(); ?>
            ...
            <a class="btn btn-danger btn-sm" href="<?php echo e(route('admin_verify_streamer' , [$streamer->id,'d'])); ?>"><i class="fas fa-times fa-sm"></i> Deny</a>
            <?php endif; ?>  
              </td>
            </tr>
            <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Tamkin\Desktop\Nouveau dossier\plateforme-seminaire\resources\views/admin_streamer.blade.php ENDPATH**/ ?>