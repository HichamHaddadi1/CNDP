...
class BigBlueButtonTest extends TestCase
{
    ...
    public function testCreateMeetingWithDocumentUrl()
    {
        ...
        $params->addPresentation('https://picsum.photos/3750/2160/?random');
    ...
    {
        $params = $this->getCreateMock($this->generateCreateParams());
        $params->addPresentation('https://picsum.photos/3750/2160/?random', null, 'placeholder.png');
    ...
    {
        $params = $this->getCreateMock($this->generateCreateParams());
        $params->addPresentation('https://picsum.photos/3750/2160/?random', null, 'presentation.png');
