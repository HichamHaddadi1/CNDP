  ...
  <body>
    <div>
      <!-- <div class="layout" >
        ...
        <h1 class="display-3">{{ $details['greeting'] }}</h1>
        <div class="content container">
        <p class="display-1">{{ $details['message'] }}</p>
        </div>
        <div class="btn_login">
      ...
      <table data-module="module-2" data-thumb="thumbnails/02.png" width="100%" cellpadding="0" cellspacing="0">
                ...
                <tr>
                          ...
                          Thank you for using our platform and we would like to inform you that {{ $details['message'] }}
