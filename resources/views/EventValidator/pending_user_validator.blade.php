  ...
  <div class="col-lg-4 col-lg-offset-4">
    ...
    <tbody>
       ...
       @csrf
            ...
            <a class="btn btn-success btn-sm" href="{{ route('validator_verify_streamer' , [$streamer->id,'v'])}}"><i class="fas fa-check fa-sm"></i> Verify</a>
            <a class="btn btn-danger btn-sm" href="{{ route('validator_verify_streamer' , [$streamer->id,'d'])}}"><i class="fas fa-times fa-sm"></i> Deny</a>
            @endif
              </td>
            </tr>
            @endif
