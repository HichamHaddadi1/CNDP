														...
														<tr>
															<td style="width:100%;text-align:center;">
																<h1
																	...
																	<span class="tinyMce-placeholder">New Arrival
																		🆕</span></h1>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td>
																<div
																	...
																	<p class="text-center w-75 text-uppercase" style="margin: 0;">
                                                                    {{ $details['message'] }}    
                                                                    </p>
																</div>
															</td>
																	...
																	<a
																		...
																		<span
																			style="padding-left:20px;padding-right:20px;font-size:16px;display:inline-block;letter-spacing:normal;"><span
																				style="font-size: 16px; line-height: 2; mso-line-height-alt: 32px;">Check it out !</span></span>
                                                                    </a>
