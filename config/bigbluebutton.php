...
return [
     ...
     */
      ...
      //01-meeting
    //   'BBB_SECURITY_SALT'   => env('BBB_SECURITY_SALT', 'drXHkXdIKoEswht7c7dVCTpk6WBcQ92FinKrknYxo'),
    //   'BBB_SERVER_BASE_URL' => env('BBB_SERVER_BASE_URL', 'https://meeting.tamkine.org/bigbluebutton/'),
      //02-workplace
    //   'BBB_SECURITY_SALT'   => env('BBB_SECURITY_SALT',   'sWojC6rqUMH5oCHABjOQr5z2HgtCv9pBYlK6mOQ'),
    //   'BBB_SERVER_BASE_URL' => env('BBB_SERVER_BASE_URL', ' https://salle-complexe.tamkine.org/bigbluebutton/'),
      //03-salle-complexe
    //    'BBB_SECURITY_SALT'   => env('BBB_SECURITY_SALT', 'lpZKbWNkdvflPnCDsDnECaI9JIZlq9T1dfXDWJ2s4'),
    //    'BBB_SERVER_BASE_URL' => env('BBB_SERVER_BASE_URL', 'https://visioconference.tamtechsolution.com/bigbluebutton/'),
