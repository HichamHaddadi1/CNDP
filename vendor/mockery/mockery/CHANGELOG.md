...
* Fix shouldNotHaveReceived with HigherOrderMessage (#752)
* Deprecates shouldDeferMissing (#839)
* Adds support for return type hints in Demeter chains (#758)
* Adds shouldNotReceive to composite expectation (#757)
* Fix internal error when using --static-backup (#755)
